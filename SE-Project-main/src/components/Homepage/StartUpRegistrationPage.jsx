      ...
      <div className="col container">
        ...
        <form>
          <div className="row p-3">
            ...
            <input type="text" id="exampleInputEmail1" style={InputField} value={startupMail}/>
            </div>
            <div className="row p-3">
            ...
            <div className="row p-3" style={ButtonPrimaryStyle}>
              <ButtonPrimary title={"Register"} onclick={startupSignIn} endPoint={'start-up-landing-page'}></ButtonPrimary>
            </div>
            <div className="row p-3" style={ButtonPrimaryStyle}>
